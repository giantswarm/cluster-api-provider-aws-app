...
- Change network policies to allow the `capa-controller-manager` pod to access coredns pods.
...
[Unreleased]: https://github.com/giantswarm/cluster-api-provider-aws-app/compare/v2.23.0...HEAD
